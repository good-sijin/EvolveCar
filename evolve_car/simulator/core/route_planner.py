...
from evolve_car.simulator.core.misc import distance_vehicle, is_within_distance_ahead, compute_magnitude_angle
...
class RoutePlanner():
    ...
    def _get_waypoints(self):
        ...
        for i, (waypoint, _) in enumerate(self._waypoint_buffer):
            waypoints.append([waypoint.transform.location.x,
                             waypoint.transform.location.y, waypoint.transform.rotation.yaw])
